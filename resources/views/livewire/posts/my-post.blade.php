<div class="div">
    ...
    <div class="container ">
        <div class="profile">
            <h2 class="mt-3 text-center" style="font-size: 23px; color:dimgray;">{{Auth::user()->name}}'s Profile</h2>
        </div>
        <div class="post-body">
            ...
            <div class="col-md-10  offset-2">
                ...
                <div class="card shadow-md mt-3 {{ $post->user->gender === 'Female' ? 'f1' : 'm1' }}"  style="width: 900px">
                    <div class="card-header">
                        @if($post->isEditable())
                        <span id="dot-icon" class="float-end dropdown dropstart bg-danger">
                            <span class="fa-solid fa-edit text-light" type="button" data-bs-toggle="dropdown" aria-expanded="false"></span>
                        ...
                        <span class="time" style="position:relative; top: 10px; left: -50px;">{{ $post->created_at->format('g:i A') }}</span>
                    </div>
